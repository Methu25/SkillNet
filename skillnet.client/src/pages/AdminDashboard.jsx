        ...
        <div style={{ maxWidth: '600px', margin: '40px auto', padding: '20px', border: '1px solid #ccc', borderRadius: '8px' }}>
            ...
            <div style={{ border: '1px solid #ddd', padding: '15px', borderRadius: '4px', marginBottom: '20px' }}>
                ...
                <div style={{ display: 'flex', gap: '10px', marginBottom: '10px' }}>
                    ...
                    <button onClick={() => testEndpoint('/api/TestSecure/admin-only')} style={{ padding: '8px 12px', backgroundColor: '#dc3545', color: 'white', border: 'none', borderRadius: '4px', cursor: 'pointer' }}>Test Admin Only</button>
