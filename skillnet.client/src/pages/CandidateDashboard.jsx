...
const CandidateDashboard = () => {
    ...
    return (
        <div style={{ maxWidth: '600px', margin: '40px auto', padding: '20px', border: '1px solid #ccc', borderRadius: '8px' }}>
            <h1 style={{ color: '#17a2b8' }}>Candidate Dashboard 👤</h1>
            ...
            <div style={{ border: '1px solid #ddd', padding: '15px', borderRadius: '4px', marginBottom: '20px' }}>
                ...
                <div style={{ display: 'flex', gap: '10px', marginBottom: '10px' }}>
                    ...
                    <button onClick={() => testEndpoint('/api/TestSecure/candidate-only')} style={{ padding: '8px 12px', backgroundColor: '#17a2b8', color: 'white', border: 'none', borderRadius: '4px', cursor: 'pointer' }}>Test Candidate Only</button>
                </div>
                {testResponse && (
