...
namespace SkillNet.Application.Services
{
    public class InterviewService : IInterviewService
    {
        ...
        public async Task<EvaluationResponse?> UpdateEvaluationAsync(int interviewId, CreateEvaluationRequest request)
        {
            ...
            if (updatedEvaluation == null) return null;
        ...
        private static int CalculateOverallScore(int technicalScore, int communicationScore, int problemSolvingScore, int cultureFitScore)
        {
